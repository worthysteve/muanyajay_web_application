            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="<?php echo APPURL; ?>">About Us</a>
                        <a class="btn btn-link" href="<?php echo APPURL; ?>/contact.php">Contact Us</a>
                        <a class="btn btn-link" href="<?php echo APPURL; ?>/#reservation">Reservation</a>
                        <a class="btn btn-link" href="">Privacy Policy</a>
                        <a class="btn btn-link" href="">Terms & Condition</a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Contact</h4>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Sesay Drive, Grafton, reetown</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+232 74 283608</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>kaimbayrebecca@gmail.com</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                         <form method="POST" action="<?php echo APPURL; ?>/news.php">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Newsletter</h4>
                        <p>Signup to get the latest Newsletter on trending fashion</p>
                        <div class="position-relative mx-auto" style="max-width: 400px;">
                            <input name="email" class="form-control border-primary w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email">
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" target="_blank" href="https://steven-daniel.netlify.app/">Steven Daniel</a><br>
                        </div>
