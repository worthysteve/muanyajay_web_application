...
define("ADMINURL", "http://localhost/muanyajays/admin-panel");
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" href="#">MuaNyaJay's Stitchery</a>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/clothe-admins/show-clothes.php" style="margin-left: 20px;">Clothes</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/enquiries/show-enquiries.php" style="margin-left: 20px;">Enquiries</a>
          </li>
        </ul>
        <?php endif; ?>
